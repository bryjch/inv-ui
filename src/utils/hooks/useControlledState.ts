...
/**
 * Reference: https://github.com/adobe/react-spectrum/blob/main/packages/%40react-stately/utils/src/useControlledState.ts
 */
...
export function useControlledState<T>(
  ...
  let stateRef = useRef(stateValue) // Internal state reference for useCallback
  ...
  if (isControlled) {
    stateRef.current = value !== undefined ? value : defaultValue
  } else {
    value = stateValue
  }
